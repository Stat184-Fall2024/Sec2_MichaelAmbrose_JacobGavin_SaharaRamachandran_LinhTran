...
1\. How does the total energy production vary across European countries in 2018?
Which are the top 5 most produced ? (Bar chart)

2\. What is the proportion of energy production for the European countries in 
2018? (Pie chart)
...
Answering this question is important because it gives a better view of what 
energy security in the European Union looks like. In the event of a disaster that takes out the energy production stations of a certain country, how tolerant is that country, as well as the rest of the european union, to the fluctuations in power availability that may occur? 
#### 2. What is the proportion of energy production for the European countries in 2018?

This is an important question to answer because it allows to get a better read
into the energy "leadership" of a country, ie. which countries are "leading the
charge" in energy production. This likely corresponds to bargaining power in the
continental stage, as energy is one of the most important commodities for a
country to have. 


#### 3. How have renewable energy trends changed over time (2016–2018) for European countries? (Line chart)

Answering this question is key to gauging how close the European union is to 
it's sustainable energy goals. Regardless of actual renewable energy production,
we are able to see the rate at which countries are making a shift to renewable
energy, which serves as a marker of whether or not a country is on track to
meet the goals set by and for them, in terms of renewable energy. This is 
especially important when considering how much of a push the EU is making 
